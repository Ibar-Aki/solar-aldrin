...
// .wrangler/tmp/bundle-wwjZl3/checked-fetch.js
...
var SOLO_KY_SYSTEM_PROMPT = `\u3042\u306A\u305F\u306F\u5EFA\u8A2D\u73FE\u5834\u306E\u5B89\u5168\u7BA1\u7406AI\u30A2\u30B7\u30B9\u30BF\u30F3\u30C8\u3067\u3059\u3002
...
`;
var EXTRACTION_PROMPT = `\u4EE5\u4E0B\u306E\u4F1A\u8A71\u304B\u3089\u3001KY\u6D3B\u52D5\u306B\u95A2\u3059\u308B\u60C5\u5831\u3092\u62BD\u51FA\u3057\u3066JSON\u5F62\u5F0F\u3067\u8FD4\u3057\u3066\u304F\u3060\u3055\u3044\u3002
    ...
    try {
      if (c.env.RATE_LIMIT_KV) {
        ...
        await c.env.RATE_LIMIT_KV.put(key, String(count + 1), {
          expirationTtl: Math.ceil(cfg.windowMs / 1e3)
        });
...
// .wrangler/tmp/bundle-wwjZl3/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-wwjZl3/middleware-loader.entry.ts
